...
namespace Sun.HealthChecks;

public static class HealthChecksBuilderExtensions
{
    public static void AddSunHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<SunDatabaseCheck>("Sun DbContext Check", tags: new string[] { "database" });
        ...
        {
            settings.AddHealthCheckEndpoint("Sun Health Status", healthCheckUrl);
        });
